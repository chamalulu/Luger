...
{
    // TODO: Add notnull constraint to T.
    ...
    public readonly struct Maybe<T> : IEquatable<Maybe<T>>
    {
        ...
        internal TR MatchInternal<TR>(Func<T, TR> some, Func<TR> none) => IsSome ? some(_value) : none();
        ...
        public static Maybe<T> operator |(Maybe<T> maybe1, Maybe<T> maybe2) => maybe1.IsSome ? maybe1 : maybe2;

        public static T operator |(Maybe<T> maybe, T t) => maybe.IsSome ? maybe._value : t;
    ...
    public static class Maybe
    {
        ...
        public static Maybe<T> Some<T>(T value) => new(value ?? throw new ArgumentNullException(nameof(value)));
        ...
        public static Maybe<T> Where<T>(this Maybe<T> maybeT, Func<T, bool> func) => maybeT.Bind(t => func(t) ? maybeT : None<T>());

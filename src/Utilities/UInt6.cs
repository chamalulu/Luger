...
namespace Luger.Utilities
{
    ...
    public struct UInt6 : IEquatable<UInt6>, IComparable<UInt6>
    {
        ...
        public static explicit operator UInt6(int value) => new(value);

        public static UInt6 FromInt32(int value) => new(value);

        public static UInt6 operator +(UInt6 addend1, UInt6 addend2) => new(addend1._value + addend2._value);

        public static UInt6 Add(UInt6 left, UInt6 right) => left + right;

        public static UInt6 operator -(UInt6 minuend, UInt6 subtrahend) => new(minuend._value - subtrahend._value);
